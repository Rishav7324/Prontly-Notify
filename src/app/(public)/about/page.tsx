  ...
  return (
    <div>
      <section className="mx-auto max-w-[1200px] px-4 py-24 text-center">
        ...
        <h1 className="font-display mx-auto max-w-3xl text-[40px] font-bold leading-[1.15] text-text-primary md:text-[56px]">
      ...
      <section className="mx-auto max-w-[1200px] px-4 py-24">
        <div className="grid gap-16 md:grid-cols-2">
          <div>
            <h2 className="font-display text-3xl font-bold text-text-primary">Our Mission</h2>
          ...
          <div>
            <h2 className="font-display text-3xl font-bold text-text-primary">Our Values</h2>
      ...
      <section className="mx-auto max-w-[1200px] px-4 py-24">
        <div
          ...
          style={{
            borderColor: "rgba(4, 71, 255, 0.25)",
            background: "linear-gradient(135deg, rgba(4, 71, 255, 0.06), rgba(4, 71, 255, 0.12))",
          }}
        >
          <div className="pointer-events-none absolute -inset-x-40 -top-40 -z-10 h-[300px] rounded-full opacity-20 blur-[120px]" style={{ backgroundColor: "rgba(4, 71, 255, 0.15)" }} />
          <h2 className="font-display text-[32px] font-bold text-text-primary md:text-[44px]">Ready to get started?</h2>
