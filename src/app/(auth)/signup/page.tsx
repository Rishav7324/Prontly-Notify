  ...
  return (
    <>
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-bold text-text-primary">Create your free account</h1>
        <p className="mt-2 text-sm text-text-secondary">Join thousands of publishers using Prontly</p>
      </div>
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <label className="flex items-start gap-2.5 cursor-pointer">
          ...
          <span className="text-sm text-text-secondary -mt-0.5">
            I agree to the{" "}
            <Link href="/terms" className="text-primary hover:text-primary-400 underline underline-offset-2">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className="text-primary hover:text-primary-400 underline underline-offset-2">
              Privacy Policy
            </Link>
          </span>
        </label>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-background px-2 text-text-muted">or sign up with</span>
        </div>
      </div>
